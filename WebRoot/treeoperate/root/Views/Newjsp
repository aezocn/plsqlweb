		    ...
		    <table align="center" border="0" class="editorout" width="100%" cellpadding="0" cellspacing="0">
		       <tr>
		           <td>
		                <table align="center" border="0" width="98%" cellpadding="0" cellspacing="0">
		                   <tr><td align="left" valign="bottom" height="25" class="lagerfont"><br>View</td></tr>
		                </table>
		           </td>
		       </tr>
		       <tr>
		           <td>
		              <table align="center" border="0" class="editorin" width="98%" cellpadding="0" cellspacing="0">
		                 ...
		                 <tr>
		                    ...
		                    <td align="left" width="80%" class="smallfont">&nbsp;<input name="returnType" id="returnType" type="text" size="50" value=""></td>
		                 </tr>
		                 <tr>
		                 	<td>
		                 	<br/>
		       ...
		       <script>
				function createView() {
					...
					//alert(returnType);
					window.close();
					window.opener.showNewObject('view',name,parameters,returnType,'New','<%=nodeType%>',tablelist,'');
				}
				</script>
		       <tr>
		           <td>
						<table align="center" border="0" width="98%" cellpadding="0" cellspacing="0">
							<tr>
								<td align="right" height="30" valign="top">
									<input type="submit" value="  ok  " onclick="createView()">
