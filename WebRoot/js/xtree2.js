...
var webFXTreeConfig = {
	...
	usePersistence	: false                  //edited by jeanwendy,2009.03.14
};
...
_p.getLabelHtml = function () {
	...
	var onblur = this.getOnblur();
	var onfocus = this.getOnfocus();
	var onmouseover = this.getOnmouseover();
	var onmouseout = this.getOnmouseout();
	...
	return "<a href=\"" + webFXTreeHandler.textToHtml(this._getHref()) +
		...
		(onmouseover ? " onmouseup=\"" + onmouseover + "\"" : "") +    //take attention:change onmouseover to onmouseup,this project requires the 'onmouseup' event!(by jeanwendy,2009.03.27)
...
_p.getOnblur = function () {
	return this.onblur;
};

_p.getOnfocus = function () {
	return this.onfocus;
};

_p.getOnmouseover = function () {
	return this.onmouseover;
};

_p.getOnmouseout = function () {
	return this.onmouseout;
};

_p.getOnclick = function () {
	return this.onclick;
};
...
function WebFXTree(sText, oAction, sBehavior, sIcon, sOpenIcon, sOnblur, sOnfocus, sOnmouseover, sOnmouseout, sOnclick) {
	WebFXTreeAbstractNode.call(this, sText, oAction);
	if (sIcon) this.icon = sIcon;
	if (sOpenIcon) this.openIcon = sOpenIcon;
	if (sBehavior) this.behavior = sBehavior;
	if (sOnblur) this.onblur = sOnblur;
	if (sOnfocus) this.onfocus = sOnfocus;
	if (sOnmouseover) this.onmouseover = sOnmouseover;
	if (sOnmouseout) this.onmouseout = sOnmouseout;
	if (sOnclick) this.onclick = sOnclick;
...
function WebFXTreeItem(sText, oAction, eParent, sIcon, sOpenIcon, sOnblur, sOnfocus, sOnmouseover, sOnmouseout, sOnclick) {
	WebFXTreeAbstractNode.call(this, sText, oAction);
	if (sIcon) this.icon = sIcon;
	if (sOpenIcon) this.openIcon = sOpenIcon;
